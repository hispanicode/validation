...
$validation_translate = array(
    ...
    "es" => array(
		...
		"min_files" => "The campo :attribute field debe contener un número de archivos igual o mayor que :condition",
		"max_files" => "The campo :attribute field debe contener un número de archivos igual o menor que :condition",
